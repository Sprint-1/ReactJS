...
import SearchFlightAction from './SearchFlightAction'
 ...
 <div className="row ">
  ...
  <div className="row mt-1">
    <div className="col">
      ...
      <Link to="/searchflightaction"  id="searchsubmit" >Submit</Link>
       </div>
  <div className="text-warning ">
    ...
    <p id="searcherror" >Edit form to submit</p>
      ...
      <Switch>
        <Route path="/searchflightaction">
          
          <SearchFlightAction cred={cred}/>
        </Route>
      </Switch>
      </div>
